...
class Toolbar(QToolBar):
    ...
    def init_toolbar_buttons(self):
        ...
        self.open.setIcon(QIcon("images/toolbar/open.png"))
        self.addWidget(self.open)

        self.save = QToolButton(self)
        self.save.setIcon(QIcon("images/toolbar/save.png"))
        self.addWidget(self.save)

        self.search = QToolButton(self)
        self.search.setIcon(QIcon("images/toolbar/search.png"))
        self.addWidget(self.search)

        self.undo = QToolButton(self)
        self.undo.setIcon(QIcon("images/toolbar/undo.png"))
        self.addWidget(self.undo)

        self.redo = QToolButton(self)
        self.redo.setIcon(QIcon("images/toolbar/redo.png"))
